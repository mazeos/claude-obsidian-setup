...
### Mac
```bash
curl -sSL https://raw.githubusercontent.com/mazeos/claude-obsidian-setup/main/install.sh | bash
```

### Windows (PowerShell como Administrador)
```powershell
irm https://raw.githubusercontent.com/mazeos/claude-obsidian-setup/main/install.ps1 | iex
```
